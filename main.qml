...
ApplicationWindow {
    ...
    ListModel {
        id: appModel
        ListElement { title: "Phố Không Mùa"; singer: "Bùi Anh Tuấn" ; icon: "qrc:/Image/Bui-Anh-Tuan.png"; source: "qrc:/Music/Chac-Ai-Do-Se-Ve-Son-Tung-M-TP.mp3" }
    ...
    MediaPlayer{
        ...
        onPlaybackStateChanged: {
            ...
            }else
            {
                ...
                {
                    {
                        repeater.source=mediaPlaylist.currentItem.myData.source
                    }

                    player.source=repeater.source
                    player.play()
                }
    ...
    ButtonControl {
        ...
        onClicked: {
            ...
            var temp=mediaPlaylist.currentIndex
            if(temp==0)
            {
    ...
    ButtonControl {
        ...
        icon_released: player.playbackState == MediaPlayer.PlayingState ?  "qrc:/Image/pause.png" : "qrc:/Image/play.png"
        onClicked: {
        ...
        Connections {
            target: player
            onPlaybackStateChanged:{
                play.source=play.icon_released
            }
        }
    }
    ButtonControl {
    ...
    SwitchButton {
        ...
        status: player.loop
        property var source: mediaPlaylist.currentItem.myData.source
        onClicked: {
            if(player.loop)
            {
                player.loop=false
